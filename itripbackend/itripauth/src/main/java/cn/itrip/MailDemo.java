...
public class MailDemo {
    public static String account = "b819776953@163.com";			//替换为发件人账号
    public static String password = "IMNDZWRQNESPZFIF";					//授权码

    public static String receiveMailAccount = "819776953@qq.com";	//替换为收件人账号
    //CBSLYVLFDSUBQZEE
